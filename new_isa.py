...
class Opcode(OpcodeFormat, Enum):
    ...
    SEQ = OpcodeFormat(number=13, instruction_type=Register)
    SNE = OpcodeFormat(number=14, instruction_type=Register)
    SGT = OpcodeFormat(number=15, instruction_type=Register)
    SLT = OpcodeFormat(number=16, instruction_type=Register)
    SNL = OpcodeFormat(number=17, instruction_type=Register)
    SNG = OpcodeFormat(number=18, instruction_type=Register)
    AND = OpcodeFormat(number=19, instruction_type=Register)
    OR = OpcodeFormat(number=20, instruction_type=Register)
    ADD = OpcodeFormat(number=21, instruction_type=Register)
    SUB = OpcodeFormat(number=22, instruction_type=Register)
    MUL = OpcodeFormat(number=23, instruction_type=Register)
    DIV = OpcodeFormat(number=24, instruction_type=Register)
    REM = OpcodeFormat(number=25, instruction_type=Register)

    ADDI = OpcodeFormat(number=26, instruction_type=Immediate)
    MULI = OpcodeFormat(number=27, instruction_type=Immediate)
    SUBI = OpcodeFormat(number=28, instruction_type=Immediate)
    DIVI = OpcodeFormat(number=29, instruction_type=Immediate)
    REMI = OpcodeFormat(number=30, instruction_type=Immediate)
